...
void initialize_scaffolder_gdextension_types(ModuleInitializationLevel p_level)
{
...
extern "C"
{
	 ...
	 */
	GDExtensionBool GDE_EXPORT scaffolder_extension_init(
		...
		GDExtensionInitialization *r_initialization)
	{
		...
		init_obj.register_initializer(initialize_scaffolder_gdextension_types);
		init_obj.register_terminator(uninitialize_scaffolder_gdextension_types);
